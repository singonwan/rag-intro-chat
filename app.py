...
collection = chroma_client.get_or_create_collection(name=collection_name, embedding_function=
openai_ef)
...
# function to load documents from news_articles
...
def query_documents(question, n_results=2):
    ...
    # distance between query and document chunk
...
def generate_response(question, relevant_chunks):
    ...
    prompt = (
        ...
        "don't know. Use three sentences maximum and keep the answer consise."
        "\n\nContext:\n" + context + "\n\nQuestion:\n" + question
    )
